...
;
; To use this library, call 'sha256' for a more complete wrapper. That is,
; easier for a programmer to user. Call 'sha256_2' if you are looking for
; more speed, that is, the program is intented to do millions of hashes (or
; more). Sha256_2 has dependencies and requires that the text to be hahed
; be broken up into 64 byte blocks prior to calling sha256_2. Refer to
