...
# NOTE: The last line is commented out. Uncomment this line if you want to enable GDB or
#       LLDB (on MAC) to debug.

 qemu-system-x86_64 -drive format=vpc,file=bos.vhd -d cpu_reset -monitor stdio \
